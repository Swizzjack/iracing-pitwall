...
export const REGISTRY: WidgetDef[] = [
  ...
  },
  {
    id: 'trackMap',
    title: 'Track Map',
    render: (d) => <TrackMap snap={d.trackMap} playerCarIdx={d.tel?.playerCarIdx ?? null} info={d.info} windDir={d.tel?.windDir ?? null} />,
  ...
  },
  {
    id: 'lapHistory',
    title: 'Lap History',
    render: (d) => <LapHistory snap={d.tel} info={d.info} />,
